          ...
          <>
            ...
            <p>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <br></br>• Good: Between 8-12 clicks per second
                <br></br>• Average:
                <br></br>• Poor: Between 5-8 clicks per second
                <br></br>• Useless: Less than 5 clicks per second
              </div>
            </p>
        ...
        return (
          <>
            ...
            <p>
              ...
              <div style={{ marginLeft: "30px" }}>
                {" "}
                <br></br>● Lightning loading times make the scrolling test quick
                and straightforward.
                <br></br>● Instant free access, and we'll never ask for any
                payment details.
                <br></br>● An easy-to-use interface that makes navigating a
                breeze.
                <br></br>● A visually appealing design that is easy on the eyes.
                <br></br>● Accurate scrolling results that you can trust, share
                with your friends and improve upon.
                <br></br>● High Score Tracking: Record your personal bests
        ...
        return (
          <>
            ...
            <p>
              ...
              <p></p>A typing test like ours will also provide you with an
